...
function App() {
  ...
  // საიტის დატა
  const allProducts = [
    { id: 1, name: "GOODYEAR EAGLE SPORT 2 235/60R18 Summer (Tire)", category: "Tires", price: 600, section: "Tires", img: "./media/1.jpg" },
    { id: 2, name: "GOODYEAR EAGLE SPORT 2 215/65R17 Summer (Tire)", category: "Tires", price: 600, section: "Tires", img: "./media/2.jpg" },
    { id: 3, name: "GOODYEAR EAGLE SPORT 2 225/55R17 Summer (Tire)", category: "Tires", price: 525, section: "Tires", img: "./media/3.jpg" },
    { id: 4, name: "TOYO PROXES SPORT 2 295/40R22 Summer (Tire)", category: "Tires", price: 1200, section: "Tires", img: "./media/4.jpg" },
    { id: 5, name: "MICHELIN PILOT SPORT EV (AO) 265/40R20 Summer (Tire)", category: "Tires", price: 1080, section: "Tires", img: "./media/5.jpg" },
    { id: 6, name: "MICHELIN PILOT SPORT 4S 275/35R21 Summer (Tire)", category: "Tires", price: 2340, section: "Tires", img: "./media/6.png" },
    { id: 7, name: "PIRELLI P ZERO (J) (LR) 265/40R22 Summer (Tire)", category: "Tires", price: 1240, section: "Tires", img: "./media/7.jpg" },
    { id: 8, name: "PIRELLI PZERO WINTER 245/40R20 Winter (Tire)", category: "Tires", price : 1300, section: "Tires", img: "./media/8.jpg" },
    { id: 9, name: "CONTINENTAL WINTERCONTACT 255/60R20 Winter (Tire)", category: "Tires", price: 110 , section: "Tires", img: "./media/9.jpg" },
    { id: 10, name: "BRIDGESTONE TURANZA 6 255/45R20 Summer (Tire)", category: "Tires", price: 740, section: "Tires", img: "./media/10.png" },
    ...
    { id: 24, name: "Mobil 1FS 5W40 1L Formula (ENGINE OIL) ", category: "Engine Oil", price: 45, section: "Engine Oil", img: "./media/24.jpg" },
    ...
    { id: 32, name: "TEXTAR 25133001 (Front Brake Pad)", category: "Brake Pads", price: 530, section: "Brake Pads", img: "./media/32.jpg" },
